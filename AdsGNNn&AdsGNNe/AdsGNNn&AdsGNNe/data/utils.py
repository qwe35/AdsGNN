...
class InputFeatures(object):
    ...
    def __init__(self, input_ids, attention_mask=None, token_type_ids=None, label=None, row_id=None):
...
class SingleSentenceClassificationProcessor(DataProcessor):
    ...
    def get_features(
        ...
        for (ex_index, (input_ids, example)) in enumerate(zip(all_input_ids, self.examples)):
            ...
            features.append(InputFeatures(input_ids=input_ids, attention_mask=attention_mask, label=label, row_id=int(example.guid)))
