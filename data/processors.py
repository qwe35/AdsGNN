...
"""
    Update for the ads relevance and CTR task
"""
...
def glue_convert_examples_to_features(
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        features.append(
            InputFeatures(
                input_ids=input_ids, attention_mask=attention_mask, token_type_ids=token_type_ids, label=label, row_id=int(example.guid)
            )
        )
...
class QkRegProcessor(DataProcessor):
    """
    Processor for the Q-K ads dataset
    ...
    def _create_examples(self, lines, set_type):
        ...
        For schema :rid,label,query,doc,taskid
...
class QkClsProcessor(DataProcessor):
    """
    Processor for the Q-K ads dataset
...
glue_processors = {
    ...
    "qkreg": QkRegProcessor,
    "qkclf": QkClsProcessor,
}

glue_output_modes = {

    "qkreg": "regression",
    "qkclf": "classification2",
}